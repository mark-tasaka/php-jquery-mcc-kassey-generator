...
<html>
<head>
<title>Launch Page: Kassey Character Generator</title>
...
<body>
	...
	<section>
        ...
        <br/>
            ...
            <br/>    
			<form action="" id ="kasseyForm"  target="_blank" method="post">
		...
		<div class="content8">
			  ...
			  <select id="level" class="dropdownmenu2Iconic">
				<option value="01" selected>Kassey, Level 1</option>
				<option value="02">Kassey, Level 2</option>
				<option value="03">Kassey, Level 3</option>
				<option value="04">Kassey, Level 4</option>
				<option value="05">Kassey, Level 5</option>
				<option value="06">Kassey, Level 6</option>
				<option value="07">Kassey, Level 7</option>
				<option value="08">Kassey, Level 8</option>
				<option value="09">Kassey, Level 9</option>
				<option value="10">Kassey, Level 10</option>
			  </select>
        ...
        {
            $("#kasseyForm").attr('action', "kassey/kassey"+ $("#level").val() +  ".php");
        });
