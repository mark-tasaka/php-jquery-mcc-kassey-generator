...
<html>
<head>
<title>Iconic NPC Kassey Character Generator</title>
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
	...
	<link rel="stylesheet" type="text/css" href="css/mcc_kassey.css">
	<link rel="stylesheet" type="text/css" href="css/mcc_kassey_post.css">
...
<!-- JQuery -->
  ...
  <script>
	...
	/*
	 Character() - Kassey Character Constructor
	*/
	function Character() {
    ...
    let manimal = getKassey();
		...
		let manimalCharacter = {
			...
			"init": 2 + agilityModifier + adjustInit(birthAugur, luckModifier),
    ...
    /*getKassey() return the statistics for the Manimal per level*/  
    function getKassey() {
	var manimal = [
	...
	return manimal[7]; 
       ...
       let imgData = "images/kassey_character_sheet.png";
